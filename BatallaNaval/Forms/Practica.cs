...
namespace BatallaNaval.Forms
{
    public partial class Practica : Form
    {
        ...
        private void InicializarPractica()
        {
            ...
            {
                gridPractica.RowStyles.Add(new RowStyle(SizeType.Percent, 100f / gridPractica.RowCount));
            }

            for (int i = 0; i < gridPractica.ColumnCount; i++)
            {
                gridPractica.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100f / gridPractica.ColumnCount));
            }
